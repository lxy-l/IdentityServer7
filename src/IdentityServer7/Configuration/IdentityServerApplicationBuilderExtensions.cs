...
namespace Microsoft.AspNetCore.Builder
{
    ...
    public static class IdentityServerApplicationBuilderExtensions
    {
        ...
        public static void Validate(this IApplicationBuilder app)
        {
            ...
            var logger = loggerFactory.CreateLogger("IdentityServer7.Startup");
            logger.LogInformation("Starting IdentityServer7 version {version}", typeof(IdentityServer7.Hosting.IdentityServerMiddleware).Assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>().InformationalVersion);

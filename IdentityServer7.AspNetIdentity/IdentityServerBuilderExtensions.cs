...
using IdentityServer7.AspNetIdentity;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class IdentityServerBuilderExtensions
    {
        ...
        public static IIdentityServerBuilder AddAspNetIdentity<TUser>(this IIdentityServerBuilder builder)
            where TUser : class
        {
            builder.Services.AddTransientDecorator2<IUserClaimsPrincipalFactory<TUser>, UserClaimsFactory<TUser>>();
        ...
        public static void AddTransientDecorator2<TService, TImplementation>(this IServiceCollection services)
            where TService : class
            where TImplementation : class, TService
        {
            services.AddDecorator2<TService>();
            services.AddTransient<TService, TImplementation>();
        }

        public static void AddDecorator2<TService>(this IServiceCollection services)
        {
